...
$sql = "SELECT * FROM peminjaman INNER JOIN buku ON peminjaman.id_buku = buku.id_buku 
    ...
    <div class="row mt-4">
        <div class="col-md-7">
            ...
            <hr class="bg-light">                
                ...
                <strong>Denda yang harus dibayar : </strong>Rp 2000
                </td>                    
                </tr>
                <?php
                if(@$detail['denda'] > 0)
                ...
                <a class="btn btn-primary <?php if($detail['tgl_kembali'] != NULL) ?>" href="form-kembali.php?id_pinjam=<?= $detail['id_pinjam'] ?>&id_buku=<?= $detail['id_buku'] ?>" role="button">
                Form Pengembalian
                </a>
                </td>
                </tr>
