...
$sql = "SELECT * FROM peminjaman INNER JOIN anggota 
        ...
        peminjaman.id_petugas = petugas.id_petugas INNER JOIN detail_pinjam ON peminjaman.id_pinjam = detail_pinjam.id_pinjam
...
<a href="form-pinjam.php?id_pinjam=<?= $p['id_pinjam'] ?>" class="badge badge-primary">Tambah</a>     
<?php
